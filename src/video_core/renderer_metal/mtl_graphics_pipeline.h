...
struct MetalAsyncHandle {
public:
    MetalAsyncHandle(bool is_done_ = false) : is_done{is_done_} {}
...
struct Shader : public Common::MetalAsyncHandle {
...
class GraphicsPipeline : public Common::MetalAsyncHandle {
public:
