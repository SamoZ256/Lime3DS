...
#include "video_core/renderer_metal/mtl_platform.h"
#include "video_core/renderer_metal/mtl_present_window.h"
#include "video_core/renderer_metal/mtl_scheduler.h"
#include "video_core/renderer_metal/mtl_swapchain.h"

#include <vk_mem_alloc.h>

MICROPROFILE_DEFINE(Metal_WaitPresent, "Vulkan", "Wait For Present", MP_RGB(128, 128, 128));
...
Frame* PresentWindow::GetRenderFrame() {
    MICROPROFILE_SCOPE(Metal_WaitPresent);
