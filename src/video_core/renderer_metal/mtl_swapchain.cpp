...
MICROPROFILE_DEFINE(Metal_Acquire, "Vulkan", "Swapchain Acquire", MP_RGB(185, 66, 245));
MICROPROFILE_DEFINE(Metal_Present, "Vulkan", "Swapchain Present", MP_RGB(66, 185, 245));
...
bool Swapchain::AcquireNextImage() {
    ...
    MICROPROFILE_SCOPE(Metal_Acquire);
...
void Swapchain::Present() {
    ...
    MICROPROFILE_SCOPE(Metal_Present);
    try {
