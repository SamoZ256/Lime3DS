...
#include "video_core/renderer_metal/mtl_memory_util.h"
#include "video_core/renderer_metal/mtl_shader_util.h"
...
MICROPROFILE_DEFINE(Metal_RenderFrame, "Vulkan", "Render Frame", MP_RGB(128, 128, 64));
...
void RendererMetal::PrepareDraw(Frame* frame, const Layout::FramebufferLayout& layout) {
...
void RendererMetal::RenderToWindow(PresentWindow& window, const Layout::FramebufferLayout& layout,
                                   bool flipped) {
...
void RendererMetal::CompileShaders() {
    vk::Device device = instance.GetDevice();
...
void RendererMetal::BuildLayouts() {
...
void RendererMetal::BuildPipelines() {
...
void RendererMetal::ConfigureFramebufferTexture(TextureInfo& texture,
...
void RendererMetal::FillScreen(Common::Vec3<u8> color, const TextureInfo& texture) {
    return;
...
void RendererMetal::ReloadPipeline() {
...
void RendererMetal::DrawSingleScreen(u32 screen_id, float x, float y, float w, float h,
...
void RendererMetal::DrawSingleScreenStereo(u32 screen_id_l, u32 screen_id_r, float x, float y,
                                           float w, float h,
                                           Layout::DisplayOrientation orientation) {
...
void RendererMetal::DrawTopScreen(const Layout::FramebufferLayout& layout,
...
void RendererMetal::DrawBottomScreen(const Layout::FramebufferLayout& layout,
...
void RendererMetal::DrawScreens(Frame* frame, const Layout::FramebufferLayout& layout,
                                bool flipped) {
...
void RendererMetal::RenderScreenshot() {
...
void RendererMetal::RenderScreenshotWithStagingCopy() {
...
bool RendererMetal::TryRenderScreenshotWithHostMemory() {
