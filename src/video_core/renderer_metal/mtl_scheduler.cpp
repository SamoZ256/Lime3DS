...
MICROPROFILE_DEFINE(Metal_WaitForWorker, "Vulkan", "Wait for worker", MP_RGB(255, 192, 192));
MICROPROFILE_DEFINE(Metal_Submit, "Vulkan", "Submit Exectution", MP_RGB(255, 192, 255));
...
void Scheduler::WaitWorker() {
    ...
    MICROPROFILE_SCOPE(Metal_WaitForWorker);
    DispatchWork();
...
void Scheduler::SubmitExecution(vk::Semaphore signal_semaphore, vk::Semaphore wait_semaphore) {
    ...
    Record([signal_semaphore, wait_semaphore, signal_value, this](vk::CommandBuffer cmdbuf) {
        MICROPROFILE_SCOPE(Metal_Submit);
