...
EmuWindow_SDL2_MTL::EmuWindow_SDL2_MTL(Core::System& system, bool fullscreen, bool is_secondary)
...
std::unique_ptr<Frontend::GraphicsContext> EmuWindow_SDL2_MTL::CreateSharedContext() const {
